...
static void init_ghi123_hvt_lgd_lcm(void)
{
...
static void init_ghi123_hvt_inx_rubbing_lcm(void)
{
	unsigned int data_array[64];
...
static void lcm_init(void)
{
	...
	if(vendor_id == 0)
		init_ghi123_hvt_lgd_lcm(); /* LGD panel */
	else
		init_ghi123_hvt_inx_rubbing_lcm(); /* INX panel */
